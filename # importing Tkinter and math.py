...
class calc:
    ...
    def __init__(self,master):
            ...
            master.geometry()
            self.e = Entry(master)
            self.e.grid(row=0,column=0,columnspan=6,pady=13)
            ...
            Button(master,text='C',width=5,height=3,
                   fg="black",bg="light green",
                   command=lambda:self.clear1()).grid(row=2, column=4)
            ...
            Button(master,text="%",width=5,height=3,
                   fg="black",bg="light green",
                   command=lambda:self.action('/100')).grid(row=4, column=2)
            ...
            Button(master,text="1",width=5,height=3,
                   fg="black",bg="light green",
                   command=lambda:self.action(1)).grid(row=1, column=0)
 
            Button(master,text="2",width=5,height=3,
                   fg="black",bg="light green",
                   command=lambda:self.action(2)).grid(row=1, column=1)
 
            Button(master,text="3",width=5,height=3,
                   fg="black",bg="light green",
                   command=lambda:self.action(3)).grid(row=1, column=2)
            ...
            Button(master,text="x²",width=5,height=3,
                   fg="black",bg="light green",
                   command=lambda:self.square()).grid(row=3, column=4)
